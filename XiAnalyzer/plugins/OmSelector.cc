...
// Class:      OmSelector
//
/**\class OmSelector OmSelector.cc RiceHIG/V0Analysis/src/OmSelector.cc
...
//#include "RiceHIG/V0Analysis/interface/OmSelector.h"
#include "../interface/OmSelector.h" // For interactive run on lxplus
...
// Constructor
OmSelector::OmSelector(const edm::ParameterSet& iConfig)
{
    using std::string;
...
// Producer Method
void OmSelector::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void OmSelector::beginJob() {

}


void OmSelector::endJob() {

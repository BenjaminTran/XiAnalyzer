...
// Class:      OmSelector
//
/**\class OmSelector OmSelector.h RiceHIG/V0Analysis/interface/OmSelector.h
...
class OmSelector : public edm::EDProducer {
public:
  explicit OmSelector(const edm::ParameterSet&);
  ~OmSelector();

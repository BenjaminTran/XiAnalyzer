...
# OmXi onl
process.OmXiMassPtAnalysis = cms.Sequence(process.selectV0CandidatesLowXiRapidity*process.selectOmegaCandidatesNewRapidity*process.MassPtRapidityMB)
...
process.p = cms.Path(process.OmXiMassPtAnalysis)

...
v0CasCorrelationRapidity = v0CasCorrelation.clone(
        ...
        # mean_om      = cms.untracked.vdouble(1.67306 ,1.67284 ,1.6728 ,1.67268 ,1.67272 ,1.6727 ,1.67262 ,1.67269 ,1.67279), # For Original Pt binning
        # sigma_om     = cms.untracked.vdouble(0.00762585 ,0.00910153 ,0.00762863 ,0.00588798 ,0.00553094 ,0.00401328 ,0.00372463 ,0.00354882 ,0.00479006), #For Original Pt binning
        mean_om      = cms.untracked.vdouble(1.6727,1.6727,1.6727,1.6727,1.6727), #Rebin v1
        sigma_om     = cms.untracked.vdouble(0.0047,0.0040,0.0034,0.0032,0.0033), #Rebin v1
        ...
        # ptcut_om     = cms.untracked.vdouble(1.5, 1.8, 2.2, 2.8, 3.6, 4.6, 6.0, 7.2, 10.0), #Original Pt binning
        ptcut_om     = cms.untracked.vdouble(1.5, 2.2, 2.8, 3.6, 5.0, 8.0), # Rebin v1

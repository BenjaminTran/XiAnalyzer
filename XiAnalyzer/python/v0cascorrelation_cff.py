...
v0CasCorrelationRapidity = v0CasCorrelation.clone(
        ...
        ptbin_n_cas_        = cms.untracked.int32(9),
        ...
        mean_xi    = cms.vdouble(1.32339 ,1.3227 ,1.32243 ,1.32234 ,1.32224 ,1.32218 ,1.32214 ,1.3221 ,1.32208),
        sigma_xi   = cms.vdouble(0.00546234 ,0.00477726 ,0.00445783 ,0.00400124 ,0.00382872 ,0.00379973 ,0.00392485 ,0.00394356 ,0.00484037),
        mean_om    = cms.vdouble(1.67284 ,1.6728 ,1.67268 ,1.67272 ,1.6727 ,1.67262 ,1.67269 ,1.67279),
        sigma_om   = cms.vdouble(0.00910153 ,0.00762863 ,0.00588798 ,0.00553094 ,0.00401328 ,0.00372463 ,0.00354882 ,0.00479006),
